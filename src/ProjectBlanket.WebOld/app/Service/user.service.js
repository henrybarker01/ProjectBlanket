...
var UserService = (function () {
    ...
    UserService.prototype.getById = function (id) {
        return this._http.get('/api/users/' + id, this.jwt()).map(function (response) { return response; });
    };
    UserService.prototype.create = function (user) {
        return this._http.post(global_1.Global.BASE_USER_ENDPOINT + 'account/register', user);
    };
    UserService.prototype.update = function (user) {
        return this._http.put('/api/users/' + user.id, user, this.jwt()).map(function (response) { return response; });
    };
