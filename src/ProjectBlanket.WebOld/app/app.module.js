...
var alert_component_1 = require("./Directive/alert.component");
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.ReactiveFormsModule, http_1.HttpModule, app_routing_1.routing, ng2_bs3_modal_1.Ng2Bs3ModalModule, angular_gridster2_1.GridsterModule],
        ...
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' },
            ...
            //    multi: true
            //},
            user_service_1.UserService, quote_service_1.QuoteService, authentication_service_1.AuthenticationService, auth_1.AuthGuard, alert_service_1.AlertService],
